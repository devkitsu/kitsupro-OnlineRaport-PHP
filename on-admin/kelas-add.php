...
if (isset($_REQUEST['add'])){
  ...
  if ($_REQUEST['kelas'] == 'none'){
    print "<script>alert('Pastikan Anda telah melengkapi semua form!');history.go(-1);</script>";
  }else{
    $sql = "INSERT INTO kelas (nm_kelas) VALUES ('$kelas')";
    $query = mysqli_query($con, $sql);
    if (mysqli_affected_rows($con)>0){
      print "<script>alert('Data kelas BERHASIL ditambahkan!');window.location='index.php';</script>";
    }else{
      print "<script>alert('Data kelas GAGAL ditambahkan. Silahkan ulangi kembali!');history.go(-1);</script>";
    }//if affected
  }//if k1
}// if isset
?>
        ...
        <div class="box-body">
          ...
          <form class="form form-horizontal" method="POST">
            <div class="form-group">
              ...
              <div class="col-md-5">
                <input type="text" class="form-control" placeholder="Nama Kelas" name="kelas" required="">
              </div>
            </div>
            <div class="form-group">
